# Linux Voice Assistant - AI Policy

We support using AI (i.e., LLMs) as tools when contributing to Linux Voice Assistant. However, you are responsible for any contributions you submit, and we are responsible for any contributions we merge and release. We hold a high bar for all contributions to our projects.
...
Contributions that do not follow this policy will be closed. Repeated violations may result in being blocked from contributing to LVA projects.